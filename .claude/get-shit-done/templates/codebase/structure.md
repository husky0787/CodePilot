...
- Usage: Reference from command with `@/home/user_demo/Husky/Codepilot-3/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/user_demo/Husky/Codepilot-3/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/user_demo/Husky/Codepilot-3/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
