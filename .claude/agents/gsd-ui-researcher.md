...
Use template from `/home/user_demo/Husky/Codepilot-3/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/user_demo/Husky/Codepilot-3/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/user_demo/Husky/Codepilot-3/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
