...
- [ ] **SAND-01**: CodePilot 以纯 Next.js Web 模式运行，所有 Electron IPC 调用优雅降级为 Web 替代方案
- [ ] **SAND-02**: 自定义 E2B 沙箱模板预装 Node.js、Claude Code CLI、better-sqlite3、全部 CodePilot 依赖
- [ ] **SAND-03**: 沙箱内 Next.js 绑定 `0.0.0.0` 并通过 E2B 端口暴露供外部浏览器访问
...
- [ ] **LIFE-03**: 入口站点支持输入多个 AI Provider 的 API Key（Anthropic/OpenAI/Google 等）
